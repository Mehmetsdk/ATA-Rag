"""Pydantic request/response schemas — CONTRACTS.md §3."""
...
class ChatRequest(BaseModel):
    ...
    @classmethod
    def history_length(cls, value: list[ChatMessage]) -> list[ChatMessage]:
...
class Source(BaseModel):
    ...
    source_type: Literal["website", "pdf"] | str | None = None
