      ...
      <div className="flex flex-wrap gap-2">
        {SUGGESTED_QUESTIONS.map((question) => {
          const questionDisabled =
            disabled || Boolean(isQuestionDisabled?.(question));
          ...
          return (
            <button
              ...
              className={cn(
                "max-w-full min-h-10 rounded-md border border-[var(--border)] bg-[var(--surface)] px-3 py-2 text-left text-sm font-serif text-[var(--foreground)] break-words",
